...
final class MovieReleaseInfoTableViewCell: UITableViewCell {
    ...
    private let durationImageView = UIImageView().createSystemIconImageView(iconName: ImageConstants.durationImageName)
    ...
    private let ganrerImageView = UIImageView().createSystemIconImageView(iconName: ImageConstants.genresImageName)
